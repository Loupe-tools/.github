...
- 🎯 **Built-in YARA engine** — in-browser rule matching with **502 default rules** across 20 category files; drop in your own `.yar` files to extend
- 🔎 **IOC extraction** — URLs, IPs, emails, hostnames, domains, file/UNC paths, hashes (MD5/SHA-1/SHA-256), GUIDs, cert fingerprints, MAC addresses. Defanged indicators (`hxxp://`, `1[.]2[.]3[.]4`) refanged automatically
